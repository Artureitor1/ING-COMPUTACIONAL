clear all
close all
elementsNumberArray = [4, 6, 8, 10, 20, 40, 80];
...
% Plot
u = polyfit(log(1./elementsNumberArray),log(errorArray(:,1)),1)
uder = polyfit(log(1./elementsNumberArray),log(errorArray(:,2)),1)
...
legend(['Displacement; slope: ',num2str(u(1))], ['Derivative; slope: ',num2str(uder(1))], 'location', 'northeast', 'Interpreter', 'latex', 'FontSize',12)
hold off

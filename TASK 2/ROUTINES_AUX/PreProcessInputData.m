function [COOR,CN,TypeElement,CONNECTb,TypeElementB, ConductMglo, dR,rnod,qFLUXglo,CNb,fNOD,NameFileMesh] = PreProcessInputData(NameFileMeshDATA,PROPMAT,DIRICHLET,NEUMANN, fSOURCE)
